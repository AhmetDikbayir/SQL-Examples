...
--1. Add a new column called ‘termination_date’ onto 
--the hcm.employees table. Give this new column a data type of DATE.
ALTER TABLE hcm.employees
ADD termination_date DATE;

--2. Write two SQL statements to change the data type of the
...
--3. Use sp_rename to rename the column name 'phone' to
